      ...
      <div className="card card-custom" key={props.id}>
        ...
        <ul className="list-group list-group-flush">
          <li className="list-group-item card-bg-color">
              <div className="row">
                <div className="col-2"><a><object data="img/done.png" width="27" height="27"> </object></a></div>
          ...
          <li className="list-group-item card-bg-color">
              <div className="row">
                <div className="col-2"><object data="img/Steak.png" width="27" height="27"> </object></div>
          ...
          <li className="list-group-item card-bg-color">
              <div className="row">
                <div className="col-2"><object data="img/Pizza.png" width="27" height="27"> </object></div>
          ...
          <li className="list-group-item card-bg-color">
              <div className="row">
                <div className="col-2"><object data="img/Love.png" width="27" height="27"> </object></div>
